    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (listBox1.Items.Contains(e.KeyCode))
            {
                ...
                // by callinsg its Update() method with the arguement true
                stats.Update(true);
            }
            else
            {
                // The userpressed an incorect key, so upate the Stats object
                // by calling its Update() thod with the arguement false
                stats.Update(false);
            }
